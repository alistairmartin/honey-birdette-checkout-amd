...
INSERT INTO "new_ThemeCopyLog" ("copiedBy", "createdAt", "error", "fileCount", "filesJson", "id", "imagesJson", "sourceShop", "sourceThemeId", "sourceThemeName", "status", "successCount", "targetShop", "targetThemeId", "targetThemeName", "targetThemeRole") SELECT "copiedBy", "createdAt", "error", "fileCount", "filesJson", "id", "imagesJson", "sourceShop", "sourceThemeId", "sourceThemeName", "status", "successCount", "targetShop", "targetThemeId", "targetThemeName", "targetThemeRole" FROM "ThemeCopyLog";
